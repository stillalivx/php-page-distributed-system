...
<html lang="es">
    <head>
        <title>Cargo | Recursos Humanos</title>
    ...
    <body class="bg-neutral-900">
        <div class="grid grid-rows-[auto_1fr] my-5">
            <header class="grid grid-cols-[15%_1fr]">
                <div></div>
                <h1 class="text-4xl font-medium text-slate-200 ml-5">Cargo</h1>
            </header>
                        ...
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" class="grid grid-cols-[1fr_auto] items-center mb-0">
                            <div class="mr-10 space-y-5">
                                <div class="grid grid-rows-[auto_auto]">
                                    ...
                                    <input required type="text" name="name" id="name" placeholder="Nombre del cargo" value="<?php echo isset($_GET["name"]) ? $_GET["name"] : "" ?>" class="outline-none bg-neutral-800 border-solid border-b-2 py-1 border-neutral-700 text-neutral-50 focus:border-blue-400" />
                                </div>
                                <div class="grid grid-rows-[auto_auto]">
                                    <label for="expLevel" class="text-xs mb-2 text-neutral-400">Nivel de experiencia</label>
                                    <input required type="text" name="expLevel" id="expLevel" placeholder="Nivel de experiencia requerido" value="<?php echo isset($_GET["expLevel"]) ? $_GET["expLevel"] : "" ?>" class="outline-none bg-neutral-800 border-solid border-b-2 py-1 border-neutral-700 text-neutral-50 focus:border-blue-400" />
                                </div>
                                <div class="grid grid-rows-[auto_auto]">
                            ...
                            <div class="py-5">
                                <table class="w-full">
                                    ...
                                    <tr class="text-neutral-400">
                                        ...
                                        <th class="border border-solid border-neutral-500 py-2.5 px-3 text-left">Nivel de experiencia</th>
                                    ...
                                    <?php foreach ($result as $key => $value): ?>
                                        <tr class="text-white">
                                            ...
                                            <td class="border border-solid border-neutral-500 py-2.5 px-3"><?php echo $value["NIVEL_EXP"]; ?></td>
                                            ...
                                            <td class="border border-solid border-neutral-500 py-2.5 px-3">
                                                <div class="flex text-xl justify-center">
                                                    <button class="mr-5" onclick="updateItem('cargo', '<?php echo "action=update&id={$value["ID"]}&name={$value["NOMBRE"]}&expLevel={$value["NIVEL_EXP"]}&salary={$value["SALARIO"]}"; ?>')">
                                                        <i class="bx bx-edit-alt text-amber-300"></i>
                                                    </button>
                                                    <button onclick="deleteItem('cargo', <?php echo $value["ID"]; ?>)">
